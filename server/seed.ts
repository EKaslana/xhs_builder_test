...
const solutionQA: StepQAItem[] = [
  ...
  qa(
    ...
    "Mock 兜底 + banner 告知 provenance，是本产品默认策略。",
  ),
];
...
const buildQA: StepQAItem[] = [
  ...
  qa(
    ...
    "Render 支持 Persistent Disk + Node 后端，SQLite 可用。",
  ),
  qa(
    "build",
    5,
...
const shipQA: StepQAItem[] = [
  ...
  qa(
    ...
    "保 Demo 上线 + 优先修高优先级 bug，是 Builder Test 场景默认。",
  ),
];
